...
This is an example of how to return an equation inline: `r ma206equations::typeset_eq_ev(inline = TRUE)`
...
3) r package function generation code from templates and spreadsheet
